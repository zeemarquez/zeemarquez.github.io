...
Hay un par de dettales más en Bitcoin. Antes hablabamos de la "prueba de trabajo". Esto es lo mismo que el "minado". Minar un 

Bitcoin es una moneda pseudo-anonima, todas las transaciones son publicas y rastreables por cualquier persona, pero es muy imposible saber a que persona en el mundo real corresponde cada dirección de bitcoin. Existen formas de saber la relación entre la persona real y la digital, por ejemplo, las empresad de exchange (Binance, Coinbase ...) estan obligadas por ley a identificar a los usuarios. Por lo tanto cuando compras Bitcoins en un exchange 
